image_path=./data/portrait_dataset/
save_root=./data/portrait_cond

USE_NUM=8

oldIFS=$IFS
IFS=$'\n'
templates=(`ls -d ${image_path}/accept_arrow_data*txt`)
...
do
    {
        ...
        CUDA_VISIBLE_DEVICES=$i python3 faceanalysis.py \
